...
\begin{aug}
\author{Yihui Xie\thanks{Corresponding author.}\ead[label=e1]{xie@yihui.name}\ead[label=u1,url]{http://yihui.name}},
...
is created by repeated changes to the $X$ and $Y$ values displayed in a scatterplot,
