...
Linked graphics is more tricky - it allows changes across different displays
as well as across different aggregation levels of the data. For example,
suppose we have a scatterplot of the variable $Y$ versus $X$, and a
